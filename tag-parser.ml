...
let parsers = (disj_list [constParsers; ifParsers; quasiquoteParser ; varParser; orParser; lambdaParser; applicationParser; definitionParser; setBangParser; explicitSeqParser;(*letParsers*)]) in parsers sexpr 
